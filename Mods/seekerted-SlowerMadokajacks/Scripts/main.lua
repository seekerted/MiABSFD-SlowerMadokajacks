...
Utils.Init("seekerted", "SlowerMadokajacks", "1.0.0")
...
local function BTTask_FlyingRail_C__ReceiveExecuteAI(Param_BTTask_FlyingRail_C, Param_OwnerController, Param_ControlledPawn)
	...
	Utils.Log("Slowed down Madokajack attack flying speed")
end
...
RegisterInitGameStatePostHook(function(Param_AGameStateBase)
	if Utils.GI and DoesMapHaveMadokajack(Utils.GI.PlayMapNo) then
		Utils.RegisterHookOnce("/Game/MadeInAbyss/Enemies/1160Onituchibashi/AI/BTTask_FlyingRail.BTTask_FlyingRail_C:ReceiveExecuteAI",
